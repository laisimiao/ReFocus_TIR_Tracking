...
# PROMPT
cfg.PROMPT = edict()
cfg.PROMPT.TYPE = "no_prompt"  # fft, headprobe, LoRA, VPT, Adapter, ReFocus, ReFocus-Lite, no_prompt
cfg.PROMPT.NUM_TOKEN = 16
cfg.PROMPT.LORA_R = 6
cfg.PROMPT.LORA_ALPHA = 32
cfg.PROMPT.LORA_DROPOUT = 0.1
cfg.PROMPT.REFOCUS_FFD_OUTPUT_LAYER = 12
cfg.PROMPT.REFOCUS_TD_NUM = 12
...
cfg.MODEL.BACKBONE.TWO_SAME = True
...
cfg.TRAIN.TRAIN_PRINT_INTERVAL = 50
...
cfg.TEST.EPOCH = 500
# ----- new -----
cfg.TEST.REUSE_TD = False
cfg.TEST.REUSE_TD_INTERVAL = 20
