...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: str = None, display_name: str = None,
                 result_only=False):
    ...
    def run_sequence(self, seq, debug=None, epoch=60):
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        out = tracker.initialize(image, init_info, seqname=seq.name)
        if out is None:
            out = {}
