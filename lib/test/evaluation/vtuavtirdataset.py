...
class VTUAVTIRDataset(BaseDataset):

    def __init__(self, subset='st'):
        super().__init__()
    ...
    def _construct_sequence(self, sequence_name):
        anno_path_x = '{}/{}/ir.txt'.format(self.base_path, sequence_name)  # 1/10
        ...
        return Sequence(sequence_name, x_frames_list, 'vtuavtir_{}'.format(self.subset), ground_truth_rect_x.reshape(-1, 4))
